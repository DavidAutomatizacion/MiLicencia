...
documento = generar_documento(maxDigitos=10)
documentoDaviplata = "1234567890"
correo = "david.castro@yopmail.com"
correoPSE = "usuariopse@yopmail.com"
celular = "3192097403"
# Generar fecha de nacimiento entre 16 y 17 años para que sea siempre un menor de edad
fecha_nacimiento = fake.date_of_birth(minimum_age=16, maximum_age=17)
...
async def main():
    async with async_playwright() as p:
        ...
        btnUnSoloTramite = page.get_by_label("Un solo trámite")
        await btnUnSoloTramite.wait_for(state="visible", timeout=10000)
        await btnUnSoloTramite.click()        
        ...
        await page.locator('input[formcontrolname="tipoTramite"]').first.click()
        ...
        await page.locator("select#tipoDocumento").select_option("3: 3")
        ...
        await page.locator("#tipoDocumentoFE").select_option("4: 3")
        ...
        await page.click("text=Siguiente")
        await page.get_by_label("Daviplata").click()
        await page.get_by_label("La persona que pagará es distinta al titular del trámite").check()
        await page.locator("select#tipodoc").select_option("3") # 3 es tarjeta de identidad
        await page.fill("#Ndocumento", documentoDaviplata)
        
        captura_pantalla("captura08")
        
        await page.get_by_role("button", name="Continuar").click()
        
        await page.get_by_label("Acepto los términos y condiciones").click()

        captura_pantalla("captura09")

        await page.get_by_role("button", name=" Pagar con Daviplata ").click()

        #================================
        # Ingreso OTP Daviplata
        #================================
        ...
        #================================
        # IMPORTANTE, HASTA ACA LLEGA LA AUTOMATIZACIÓN, MI LICENCIA PRESENTA FALLOS CON DAVIPLATA
        #================================
